...
while numero_ronda <= rondas_permitidas:
    ...
    #pero eso no es posible ya que la computadora siempre apuesta entre 20 y 100
    ...
    print(f"El jugador eligio: {jugador_eleccion} que es {volado_tradicional(jugador_eleccion)}")
    time.sleep(1)
